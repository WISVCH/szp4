...
You can use multiple classes in your program, but you'll need to define them all in a single |.java| file. If you do this, you can't define these classes as being |public|. One of your classes should have a |main| method. The name of this class should always be |Problem| followed by a capital letter indicating the problem you solved. For example: your class that solves problem A should be called |ProblemA|. Calling it differently will result in either a \emph{compiler error} (if your class is |public|) or a \emph{runtime error} (if your class is package private, i.e. when you haven't given an access specifier).

For reading input files you can use the |Scanner| class. You can
...
documents will be brought to your computer by a runner. You are \emph{not} allowed to go to the printer to retrieve the document.
\vspace{-0.3cm}
