...
from szp.models import Clar, Clarreq, Compiler, Contest, File, Problem, Submission
from szp.forms import SubmitForm
...
def infoscript(request):
    ...
    return render_to_response('infoscript', {"problems": problems, "compilers": compilers})
